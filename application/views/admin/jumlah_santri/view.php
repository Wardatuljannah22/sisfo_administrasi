<div class="container-fluid">
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800">Data Jumlah Santri</h1>
	<!-- DataTales Example -->
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Tabel Data Jumlah Santri</h6>
		</div>
		<div class="card-body">
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Tambah Jumlah Santri</h5>
						...
						<div class="modal-body">
							...
							<label >ID JUMLAH </label>	
									<input type="text" class="form-control" id="id_jumlah" name="id_jumlah" style="background:#d5d8eb;color: #000000;">
							</div> -->

								<div class="form-group">
									<label>JUMLAH SANTRI PUTRA</label>
									<input type="text" class="form-control" id="jumlah_putra" name="jumlah_putra" style="background:#d5d8eb;color: #000000;">
								</div>

								<div class="form-group">
									<label>JUMLAH SANTRI PUTRI</label>
